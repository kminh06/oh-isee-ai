...
export async function POST(request: Request) {
  ...
  const result = await streamText({
    ...
    **Chương trình huấn luyện 7, 14 và 21 ngày (3 cấp độ Cởi mở, Kết nối, Hài lòng)**
    ...
    Khi bạn nhận thấy họ đang chia sẻ và chưa có câu hỏi bạn có thể dùng câu cảm thán "Oh, I see" để trả lời và khuyến khích họ tiếp tục trao đổi. Tuy nhiên không nên có 2 câu cảm thán này cách nhau dưới 5 dòng chat. Không dùng câu cảm thán này quá nhiều lần trong một cuộc trò chuyện. Ít nhất 5 dòng chat mới có thể dùng lại câu cảm thán này. Đừng bắt đầu mỗi câu trả lời bằng "Oh, I see". Chỉ dùng câu cảm thán này khi người dùng đang chia sẻ và không có câu hỏi cụ thể nào.
